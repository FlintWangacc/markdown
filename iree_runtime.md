...
(lldb) bt
* thread #1, name = 'iree-run-module', stop reason = step over
  * frame #0: 0x00005555555c97d4 iree-run-module`iree_io_parameter_op_batch_resolve_entry(batch=0x00007fffffff9038, scope=<unavailable>, enumerator=<unavailable>, i=0, access=1, out_entry=0x00007fffffff9030, out_span=<unavailable>, out_file=<unavailable>) at parameter_index_provider.c:349:26
    frame #1: 0x00005555555c8dbf iree-run-module`iree_io_parameter_index_provider_load(base_provider=<unavailable>, device=0x000055555581b680, queue_affinity=<unavailable>, wait_semaphore_list=iree_hal_semaphore_list_t @ 0x00007fffffff91e0, signal_semaphore_list=iree_hal_semaphore_list_t @ 0x00007fffffff91f8, source_scope=<unavailable>, target_params=(usage = 527363, access = 0, type = 48, queue_affinity = 18446744073709551615, min_alignment = 0), count=3, enumerator=iree_io_parameter_enumerator_t @ 0x00007fffffff9230, emitter=iree_io_parameter_emitter_t @ 0x00007fffffff9240) at parameter_index_provider.c:711:14
    frame #2: 0x00005555555cba6c iree-run-module`iree_io_parameters_module_load(stack=<unavailable>, module=<unavailable>, state=0x0000555555e87130, args=<unavailable>, rets=0x00007fffffff94e0) at module.c:324:14
    frame #3: 0x000055555569245b iree-run-module`iree_vm_native_module_issue_call(module=<unavailable>, stack=<unavailable>, callee_frame=<unavailable>, flags=<unavailable>, args_storage=<unavailable>, rets_storage=(data = "", data_length = 16)) at native_module.c:364:7
    frame #4: 0x00005555556922f9 iree-run-module`iree_vm_native_module_begin_call(self=0x00005555556b3d70, stack=0x00007fffffff98c0, call=iree_vm_function_call_t @ 0x00007fffffff9430) at native_module.c:420:10
    frame #5: 0x000055555564b474 iree-run-module`iree_vm_bytecode_issue_import_call(stack=0x00007fffffff98c0, call=iree_vm_function_call_t @ 0x00007fffffff94b0, cconv_results=<unavailable>, dst_reg_list=0x00005555556b6c6c, out_caller_frame=<unavailable>, out_caller_registers=<unavailable>) at dispatch.c:459:7
    frame #6: 0x000055555564ac4b iree-run-module`iree_vm_bytecode_call_import(stack=0x00007fffffff98c0, module_state=<unavailable>, import_ordinal=2147483668, caller_registers=iree_vm_registers_t @ 0x00005a990f6b2d50, src_reg_list=0x00005555556b6c54, dst_reg_list=0x00005555556b6c6c, out_caller_frame=0x00007fffffff9688, out_caller_registers=0x00007fffffff9690) at dispatch.c:575:10
    frame #7: 0x0000555555645692 iree-run-module`iree_vm_bytecode_dispatch(stack=<unavailable>, module=<unavailable>, current_frame=0x00007fffffff9930, regs=iree_vm_registers_t @ 0x00007fffffff9690, call_results=(data = 0x0000000000000000, data_length = 0)) at dispatch.c:1692:5
    frame #8: 0x000055555564166c iree-run-module`iree_vm_bytecode_dispatch_begin(stack=<unavailable>, module=<unavailable>, call=iree_vm_function_call_t @ 0x00007fffffff9770, cconv_arguments=<unavailable>, cconv_results=<unavailable>) at dispatch.c:643:26
    frame #9: 0x0000555555640774 iree-run-module`iree_vm_bytecode_module_begin_call(self=0x00005555556b3710, stack=0x00007fffffff98c0, call=iree_vm_function_call_t @ 0x00007fffffff9810) at module.c:850:10
    frame #10: 0x000055555568e834 iree-run-module`iree_vm_context_run_function(context=<unavailable>, stack=0x00007fffffff98c0, module=0x00005555556b3710, function_name=<unavailable>) at context.c:91:12
    frame #11: 0x000055555568e2b1 iree-run-module`iree_vm_context_register_modules(context=0x0000555555d545b0, module_count=3, modules=0x00007fffffffb9a0) at context.c:596:14
    frame #12: 0x000055555568dfb8 iree-run-module`iree_vm_context_create_with_modules(instance=0x00005555556b32b0, flags=0, module_count=3, modules=0x00007fffffffb9a0, allocator=iree_allocator_t @ 0x00005a990f2b26d0, out_context=0x00007fffffffb978) at context.c:340:7
    frame #13: 0x00005555555bd1d6 iree-run-module`iree_tooling_create_context_from_flags(instance=0x00005555556b32b0, user_module_count=1, user_modules=<unavailable>, default_device_uri=(data = 0x0000000000000000, size = 0), host_allocator=iree_allocator_t @ 0x00007fffffffbbe0, out_context=0x00007fffffffbc70, out_device=0x00007fffffffbc60, out_device_allocator=0x00007fffffffbc30) at context_util.c:658:26
    frame #14: 0x00005555555c45aa iree-run-module`iree_tooling_create_run_context(instance=0x00005555556b32b0, default_device_uri=<unavailable>, module_contents=<unavailable>, host_allocator=iree_allocator_t @ 0x00005a990f636470, out_context=<unavailable>, out_function=<unavailable>, out_device=<unavailable>, out_device_allocator=<unavailable>) at run_module.c:151:9 [inlined]
    frame #15: 0x00005555555c440a iree-run-module`iree_tooling_run_module_with_data(instance=0x00005555556b32b0, default_device_uri=(data = 0x0000000000000000, size = 0), module_contents=<unavailable>, host_allocator=iree_allocator_t @ 0x00007fffffffbef0, out_exit_code=0x00007fffffffbf2c) at run_module.c:405:3
    frame #16: 0x00005555555c43c6 iree-run-module`iree_tooling_run_module_from_flags(instance=<unavailable>, host_allocator=iree_allocator_t @ 0x00007fffffffbf00, out_exit_code=<unavailable>) at run_module.c:388:10
    frame #17: 0x00005555555b8505 iree-run-module`main(argc=1, argv=0x00007fffffffc068) at iree-run-module-main.c:43:14
